...
struct Item
{
  ...
  Item(string itemColor = "", string itemShape = "", string itemBrand = "",
       unsigned int barcode = 1000000, Item* next_ = NULL);
};
...
public:
  ...
  ItemCollection() : hT1{10, hashfct1},
                     hT2{10, hashfct2},
                     hT3{10, hashfct3},
                     hT4{10, hashfct4},
                     hT5{10, hashfct5},
...
private:
  ...
  unsigned int hT1_size,hT2_size,hT3_size,hT4_size,hT5_size,hT6_size,hT7_size;
};
